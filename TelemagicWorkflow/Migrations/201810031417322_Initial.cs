namespace TelemagicWorkflow.Migrations
{
    using System;
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        InventoryItemName = c.String(nullable: false, maxLength: 80,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "Ïndex",
                                    new AnnotationValues(oldValue: null, newValue: "IndexAnnotation: { Name: AK_InventoryItem_InventoryName, IsUnique: True }")
                                },
                            }),
                ...
                c => new
                    {
                        ...
                        OrderDateTime = c.DateTime(nullable: false, defaultValueSql: "GetDate()"), // GetDate() helps you get the current date
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        InventoryItemName = c.String(nullable: false, maxLength: 15),
                        UnitPrice = c.Decimal(nullable: false, precision: 18, scale: 2),
                ...
                .ForeignKey("dbo.WorkOrders", t => t.WorkOrderId, cascadeDelete: true)
                .Index(t => new { t.WorkOrderId, t.InventoryItemName }, unique: true, name: "AK_Part");
                ...
                {
                    {
                        ...
                        {
                            { "Ïndex", "IndexAnnotation: { Name: AK_InventoryItem_InventoryName, IsUnique: True }" },
                        }
                    },
                });
